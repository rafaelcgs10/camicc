...
![face comparison](docs/img/comparison-crop.jpg)

![full comparison](docs/img/comparison-full.jpg)

Both images and the metrics below are generated by the reproducible harness
in [`testing/`](testing/) — point it at any raw + out-of-camera JPEG pair to
